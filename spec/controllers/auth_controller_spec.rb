...
RSpec.describe AuthController, type: :controller do
  ...
  describe '#login' do
    ...
    context 'when sms code is not right' do
      it 'returns 409' do
        post :login, params: {  phone: user.phone, sms_code: '4321' }
    ...
    context 'when user exists' do
      it 'returns token' do
        ...
        post :login, params: { phone: user.phone, sms_code: '1234' }
        expect(response).to have_http_status :ok
    ...
    context 'when user not exists' do
      ...
      it 'creates new user' do
        ...
        expect do
          post :login, params: { phone: user_attributes[:phone], sms_code: '1234' }
